...
** Looky-feely stuff [0/3]
*** TODO Make emacs run icons command once when installed the first time :feat:
...
*** TODO spaceline is not maintained. dead.                  :package:nuke:
replace with doom-modeline
(doom-modeline-mode 1)
*** TODO Make modeline date follow iso8601.                           :bug:
** TODO consider replacing projectile in favour of project.el     :lookinto:
** TODO consider using =repeat-mode=.                             :lookinto:
  Instead of typing c-x o c-x o to switch windows twice, I can type lookinto.
** TODO consider vertico+consult+marginaila                       :lookinto:
  inetad of counsel/swiper/ivy
** TODO instead of tide/js2-mode use eglot                        :lookinto:
...
** TODO Update browser in emacs from chromium to chrome                :bug:
...
** DONE replace sys/emacs-root                                         :bug:
CLOSED: [2025-12-30 Tue 14:07]
I sometimes use sys/emacs-root and sometimes the built-in user-emacs-directory. It's inconsistent and will lead to bugs.
Consider changing the code in init.el like so:

#+begin_src emacs-lisp
  ; override user-emacs-directory
  (setq user-emacs-directory (file-name-directory (or load-file-name (buffer-file-name))))
#+end_src

then replace all instances of sys/emacs-root.

** DONE configure Treemacs                                          :config:
CLOSED: [2025-12-29 Mon 11:59]
Won't fix. I don't use this that much, and it works for basic usage
...
** DONE treemacs is slow                                               :bug:
CLOSED: [2025-12-29 Mon 11:59]
Won't fix. I don't use this that much, and it works for basic usage
  consdicer eaf-browser or the built-in projectile-find-file
** DONE diff-hl is very very slow                                      :bug:
CLOSED: [2025-12-29 Mon 11:45]

** DONE camelCase function:                                           :feat:
CLOSED: [2025-12-29 Mon 11:16]
...
** DONE mpg123 is unmaintained                                :package:nuke:
CLOSED: [2025-12-29 Mon 11:12]
** DONE atomic-chrome is broken                               :package:nuke:
CLOSED: [2025-12-29 Mon 11:12]
** DONE encoding overkill
CLOSED: [2025-12-19 Fri 17:36]
replace the entire section with
#+begin_src emacs-lisp
    (set-language-environment "UTF-8")
    (set-default-coding-systems 'utf-8)
#+end_src
** DONE normal-backup-enable-predicate doesn't exist.
CLOSED: [2025-12-19 Fri 16:55]
  ...
  #+end_src
** DONE consider replacing scroll-step 1 with pixel-scroll-precision-mode
CLOSED: [2025-12-19 Fri 17:19]
** DONE compile native machine code
CLOSED: [2025-12-19 Fri 22:40]
** DONE move custom.el to top of the file
CLOSED: [2025-12-19 Fri 17:20]
...
** DONE fix the '<s' problem
this feature has moved to org-temp
(require 'org-tempo)
** DONE rewrite package sections and use use-package
...
** DONE Linum-mode is slow
replaced with (display-line-numbers-mode 1) or without the arg to toggle
** DONE company-mode
