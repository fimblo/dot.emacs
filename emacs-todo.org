...
** TODO Connect emacs to default-browser
...
(require 'org-tempo)
** TODO spaceline is not maintained. dead.
...
** TODO consider replacing projectile in favour of project.el
** DONE compile native machine code
CLOSED: [2025-12-19 Fri 22:40]
** TODO consider using =repeat-mode=.
...
** TODO consider vertico+consult+marginaila
  inetad of counsel/swiper/ivy
** TODO treemacs is slow
  consdicer eaf-browser or the built-in projectile-find-file
** TODO instead of tide/js2-mode use eglot
  remove tide-js2-mode and add '(global-eglot-ensure)'
** TODO mpg123 is unmaintained
** TODO atomic-chrome is broken
** TODO diff-hl is very very slow
