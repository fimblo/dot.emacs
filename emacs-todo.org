...
** TODO consider replacing projectile in favour of project.el      :package:
** TODO consider using =repeat-mode=.                              :package:
  Instead of typing c-x o c-x o to switch windows twice, I can type c-x o o.
** TODO consider vertico+consult+marginaila                        :package:
  inetad of counsel/swiper/ivy
** TODO treemacs is slow                                               :bug:
  consdicer eaf-browser or the built-in projectile-find-file
** TODO instead of tide/js2-mode use eglot                         :package:
...
** TODO mpg123 is unmaintained                                :package:nuke:
** TODO atomic-chrome is broken                               :package:nuke:
...
** TODO diff-hl is very very slow                                      :bug:
...
** TODO configure Treemacs                                          :config:
...
** TODO write function which:                                         :feat:
