...
#+BEGIN_SRC emacs-lisp
  ...
  ;; when running emacs in batch mode, user-init-file is not set.
  (unless user-init-file
    (setq user-init-file (concat default-directory "init.el"))
  )
...
#+BEGIN_SRC emacs-lisp
  ...
  "Path to repo of this emacs configuration")
