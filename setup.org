...
#+BEGIN_SRC emacs-lisp
  (defun ff-create_title_format (user host)
  ...
  (if (eq system-type 'windows-nt)
      (setq frame-title-format (ff-create_title_format "USERNAME" "COMPUTERNAME"))
    (setq frame-title-format (ff-create_title_format "USER" "HOSTNAME")))
#+END_SRC
