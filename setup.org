...
=EMACS_SECRETSFILE=. No, this file is not in my vc.

#+BEGIN_SRC emacs-lisp
  (defconst me/emacs/secrets
    (getenv "EMACS_SECRETSFILE")       "Personal info goes here")
  ...
  ;; If me/emacs/secrets has a value, check if it points at a file. If
  ;; it exists, then load it.
  (when me/emacs/secrets
      (when (file-exists-p me/emacs/secrets)
	(load me/emacs/secrets)
	)
      )
