...
Last and probably least from your perspective, here's stuff I want to
do or test in the (near?) future.
...
- [X] company-mode
- [X] lsp-mode
- [ ] in emacs-lisp buffer, make company propose across hyphens
...
- [ ] integrate projectile into other modes.
  see [[Projectile-mode]].
...
- [ ] Just noticed that the date in the modeline doesn't follow
...
- See if I can get highlighted regions to be in whitespace-mode
