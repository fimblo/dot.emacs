...
*** TODO in emacs-lisp buffer, make company propose across hyphens
*** TODO integrate projectile into other modes.
see [[Projectile-mode]].
*** TODO Just noticed that the date in the modeline doesn't follow iso8601, which annoys me. fix!
