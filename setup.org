...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/org-checkbox-cycle ()
    ...
    (my/org-update-parent-stats))

  (defun my/org-update-parent-stats ()
  ...
  (defun my/org-ctrl-c-ctrl-c ()
    ...
    (interactive)
    (if (my/org-at-any-checkbox-p)
        (my/org-checkbox-cycle)
      (org-ctrl-c-ctrl-c)))

  (with-eval-after-load 'org
    (define-key org-mode-map (kbd "C-c C-c") #'my/org-ctrl-c-ctrl-c))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (defun my/org-item-and-children ()
  ...
  (with-eval-after-load 'org
    (define-key org-mode-map (kbd "C-c C-x >") #'my/org-migrate-todo))
#+END_SRC
